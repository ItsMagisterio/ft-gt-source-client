package controls
{
    ...
    public class PlayerInfo extends Sprite
    {
        ...
        private const normalGlowColor:uint = 0x12FF00;
        private const minusGlowColor:uint = 0xFF4000;
        ...
        public function PlayerInfo()
        {
            ...
            this.indicators.removeChild(this.indicators.kdRatio);
            this.indicators.removeChild(this.indicators.kd_icon);
            this.indicators.removeChild(this.indicators.scoreLabel);
        ...
        private function flashLabel(target:Label, color:uint = 0xFF0000):void
        {
            this.glowAlpha[target.name] = 1;
            this.glowColor[target.name] = color;
            target.addEventListener(Event.ENTER_FRAME, this.glowFrame, false, 0, false);
        }
