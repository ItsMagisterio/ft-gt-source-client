...
package logic.gui
{
    ...
    public class RecoveryWindow extends Sprite
    {
        ...
        private var passInput:TankInput = new TankInput();
        private var pass2Input:TankInput = new TankInput();
        private var emailInput:TankInput = new TankInput();
        private var saveBtn:BlueButton = new BlueButton();
        private var cancelBtn:RedButton = new RedButton();
