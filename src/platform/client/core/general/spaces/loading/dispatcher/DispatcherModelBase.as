package platform.client.core.general.spaces.loading.dispatcher
{
   ...
   public class DispatcherModelBase extends Model
   {
      ...
      protected var server:platform.client.core.general.spaces.loading.dispatcher.DispatcherModelServer;

      private var client:platform.client.core.general.spaces.loading.dispatcher.IDispatcherModelBase;
      ...
      {
         this.server = new platform.client.core.general.spaces.loading.dispatcher.DispatcherModelServer(IModel(this));
