package platform.client.fp10.core.network.connection.protection
{
   ...
   public class PrimitiveProtectionContext implements IProtectionContext
   {
      ...
      public static const INSTANCE:platform.client.fp10.core.network.connection.protection.PrimitiveProtectionContext = new platform.client.fp10.core.network.connection.protection.PrimitiveProtectionContext();
