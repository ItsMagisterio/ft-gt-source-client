package platform.client.fp10.core.resource
{
   ...
   public class Resource
   {
      ...
      protected var resourceInfo:platform.client.fp10.core.resource.ResourceInfo;

      protected var baseUrl:String;

      protected var listener:platform.client.fp10.core.resource.IResourceLoadingListener;
      ...
      private var dependents:Vector.<platform.client.fp10.core.resource.Resource>;

      private var numDependencies:int = 0;

      private var batchLoader:platform.client.fp10.core.resource.BatchResourceLoader;

      public function Resource(param1:platform.client.fp10.core.resource.ResourceInfo)
      {
         super();
         if (param1 == null)
         {
      ...
      public function addDependent(param1:platform.client.fp10.core.resource.Resource):void
      {
      ...
      public function setBatchLoader(param1:platform.client.fp10.core.resource.BatchResourceLoader):void
      {
         this.batchLoader = param1;
      }

      public function addDependence(param1:platform.client.fp10.core.resource.Resource):void
      {
      ...
      final public function loadLazyResource(param1:platform.client.fp10.core.resource.IResourceLoadingListener):void
      {
         if (this.isLoaded)
         {
      ...
      final public function removeLazyListener(param1:platform.client.fp10.core.resource.IResourceLoadingListener):void
      {
      ...
      final public function addLazyListener(param1:platform.client.fp10.core.resource.IResourceLoadingListener):void
      {
         if (!this.isLazy)
         {
      ...
      public function load(param1:String, param2:platform.client.fp10.core.resource.IResourceLoadingListener):void
      {
         if (param2 == null)
         {
      ...
      public function loadBytes(param1:ByteArray, param2:platform.client.fp10.core.resource.IResourceLoadingListener):Boolean
      {
         return false;
      }
      ...
      {
         var _loc1_:platform.client.fp10.core.resource.Resource = null;
         if (this.dependents != null)
         {
