package platform.client.fp10.core.resource
{
   ...
   public class ResourceTimer implements IResourceTimer
   {
      ...
      private var resources:Vector.<platform.client.fp10.core.resource.Resource>;
      ...
      public function addResource(param1:platform.client.fp10.core.resource.Resource):void
      {
         if (this.resources.indexOf(param1) < 0)
         {
            var _loc2_:* = this.numResources++;
      ...
      public function removeResource(param1:platform.client.fp10.core.resource.Resource):void
      {
      ...
      {
         var _loc4_:platform.client.fp10.core.resource.Resource = null;
