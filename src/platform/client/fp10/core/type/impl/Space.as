package platform.client.fp10.core.type.impl
{
   ...
   public class Space implements ISpace
   {
      ...
      public function Space(param1:Long, param2:ISpaceCommandHandler, param3:IProtocol, param4:Boolean)
      {
         ...
         var _loc6_:ConnectionInitializers = new ConnectionInitializers(param3, new SpaceRootCodec(), param2, networkService.secure, param1, _loc5_);
         this.connection = transportService.createConnection(_loc6_);
