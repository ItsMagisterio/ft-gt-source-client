package platform.client.models.commons.periodtime
{
   ...
   public class TimePeriodModelBase extends Model
   {
      ...
      protected var server:platform.client.models.commons.periodtime.TimePeriodModelServer;

      private var client:platform.client.models.commons.periodtime.ITimePeriodModelBase;
      ...
      {
         this.server = new platform.client.models.commons.periodtime.TimePeriodModelServer(IModel(this));
