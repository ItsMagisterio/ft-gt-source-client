package forms.battlelist
{
    ...
    public class BattleMap
    {
        ...
        private var _dom:Boolean;
        private var _hr:Boolean;
        ...
        public function set dom(value:Boolean):void
        {
            this._dom = value;
        }
        public function get hr():Boolean
        {
            return (this._hr);
        }
        public function set hr(value:Boolean):void
        {
            this._hr = value;
        }
