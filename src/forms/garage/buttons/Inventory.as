package forms.garage.buttons
{
    ...
    public class Inventory extends DefaultButton
    {

        private static var add:Class = Inventory_add;
        ...
        public function Inventory(text:String)
        {
            ...
            this.f.text = text;
            this.f.x = ((this.i.x + this.i.width) + 8);
