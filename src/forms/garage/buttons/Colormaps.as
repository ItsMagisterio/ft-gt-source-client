package forms.garage.buttons
{
    ...
    public class Colormaps extends DefaultButton
    {

        private static var add:Class = Colormaps_add;
        ...
        public function Colormaps(text:String)
        {
            ...
            this.f.text = text;
            this.f.x = ((this.i.x + this.i.width) + 11);
