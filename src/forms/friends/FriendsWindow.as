package forms.friends
{
   ...
   public class FriendsWindow extends Sprite
   {
      ...
      private var _incomingButton:FriendsWindowStateSmallButton;
      ...
      private function init():void
      {
         ...
         this._outgoingButton = new FriendsWindowStateBigButton(FriendsWindowState.OUTCOMING, false);
         ...
         this._incomingButton = new FriendsWindowStateSmallButton(FriendsWindowState.INCOMING, true);
      ...
      private function onClickAddFriend(event:MouseEvent):void
      {
         ...
         this._addFriendtTextInput.textField.text = "";
      }
      ...
      private function resize():void
      {
         ...
         this._incomingButton.width = _incomingButton.height;
         ...
         this._searchInListTextInput._label.sharpness = 150;
         this._searchInListTextInput._label.thickness = 150;
      ...
      public function show(param1:FriendsWindowState = null):void
      {
         ...
         switch (param1)
         {
            ...
            case FriendsWindowState.INCOMING:
               this.showIncoming();
               this._searchInListLabel.visible = true;
               PanelModel(Main.osgi.getService(IPanel)).mainPanel.buttonBar.icon.visible = false;
               var storage:SharedObject = SharedObject.getLocal("FriendsModel");
               storage.data["friendsCachedId"] = PanelModel(Main.osgi.getService(IPanel)).friendsCachedId;
               storage.flush();
               break;
            case FriendsWindowState.OUTCOMING:
               this.showOutgoing();
