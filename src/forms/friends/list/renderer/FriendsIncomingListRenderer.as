   ...
   public class FriendsIncomingListRenderer extends CellRenderer
   {
      ...
      private function createLabels(param1:Object):Sprite
      {
         ...
         if (param1.id != null)
         {
            ...
            this._userLabel.setRank(param1.rank, param1.isPremium);
            this._userLabel.setUid(param1.uid, param1.uid);
            this._userLabel.setUidColor(ColorConstants.GREEN_LABEL);
            this._userLabel.addEventListener(MouseEvent.CLICK, this.fgu);
         }
         return _loc2_;
      }
      ...
      {
         Network(Main.osgi.getService(INetworker)).send("lobby;accept_friend;" + this._userLabel.uid);
      }

      private function onClickRejectRequest(param1:MouseEvent):void
      {
         Network(Main.osgi.getService(INetworker)).send("lobby;deny_friend;" + this._userLabel.uid);
      }
