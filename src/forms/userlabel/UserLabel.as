package forms.userlabel
{
   ...
   public class UserLabel extends Sprite
   {
      ...
      private function createRankIcon():void
      {
         ...
         this._rankIcon = new SmallRankIcon(0);
      ...
      public function setRank(param1:int, premium:Boolean):void
      {
         this._rank = param1;
         this._isInitRank = true;
         this._rankIcon = new SmallRankIcon(this._rank, premium);
         if (premium)
         {
         ...
         {
            this._rankIcon.setDefaultAccount(this._rank);
         }
