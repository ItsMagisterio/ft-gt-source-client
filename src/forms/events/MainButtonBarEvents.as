package forms.events
{
    ...
    public class MainButtonBarEvents extends Event
    {
        ...
        private var types:Array = new Array(ADDMONEY, PROFILE, CHALLENGE, BATTLE, GARAGE, STAT, SETTINGS, SOUND, HELP, CLOSE, BUGS, EXCHANGE, SPINS, SOCIALNETS, FRIENDS, FULLSCREEN);
