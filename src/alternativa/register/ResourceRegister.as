package alternativa.register
{
    ...
    public class ResourceRegister implements IResourceService
    {
        ...
        {
            Main.writeVarsToConsoleChannel("RESOURCE", (((("Регистрация ресурса " + IResource(this.resources[id]).name) + " id:") + id) + " удалена"), 0x666666);
        ...
        public function registerResourceFactory(resourceFactory:IResourceFactory, resourceType:int):void
        {
            ...
            Main.writeVarsToConsoleChannel("RESOURCE", (("Loader for resource " + resourceFactory) + " registered"), 0x666666);
        }
