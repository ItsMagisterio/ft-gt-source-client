package alternativa.protocol
{
   ...
   public class ProtocolBuffer
   {
      ...
      private var _optionalMap:alternativa.protocol.OptionalMap;

      public function ProtocolBuffer(param1:IDataOutput, param2:IDataInput, param3:alternativa.protocol.OptionalMap)
      {
         super();
         this._writer = param1;
         this._reader = param2;
      ...
      public function get optionalMap():alternativa.protocol.OptionalMap
      {
         return this._optionalMap;
      }

      public function set optionalMap(param1:alternativa.protocol.OptionalMap):void
      {
