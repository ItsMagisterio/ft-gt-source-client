package alternativa.math
{
   ...
   public class Matrix3_new
   {
      ...
      public function Matrix3_new(param1:Number = 1, param2:Number = 0, param3:Number = 0, param4:Number = 0, param5:Number = 1, param6:Number = 0, param7:Number = 0, param8:Number = 0, param9:Number = 1)
      {
         super();
         this.m00 = param1;
         this.m01 = param2;
      ...
      public function toIdentity():Matrix3_new
      {
      ...
      public function invert():Matrix3_new
      {
      ...
      public function append(param1:Matrix3_new):Matrix3_new
      {
      ...
      public function prepend(param1:Matrix3_new):Matrix3_new
      {
         var _loc2_:Number = this.m00;
         var _loc3_:Number = this.m01;
         var _loc4_:Number = this.m02;
      ...
      public function prependTransposed(param1:Matrix3_new):Matrix3_new
      {
         var _loc2_:Number = this.m00;
         var _loc3_:Number = this.m01;
         var _loc4_:Number = this.m02;
      ...
      public function add(param1:Matrix3_new):Matrix3_new
      {
         this.m00 += param1.m00;
         this.m01 += param1.m01;
         this.m02 += param1.m02;
      ...
      public function subtract(param1:Matrix3_new):Matrix3_new
      {
         this.m00 -= param1.m00;
         this.m01 -= param1.m01;
         this.m02 -= param1.m02;
      ...
      public function transpose():Matrix3_new
      {
      ...
      public function createSkewSymmetric(param1:Vector3):Matrix3_new
      {
      ...
      public function copy(param1:Matrix3_new):Matrix3_new
      {
         this.m00 = param1.m00;
         this.m01 = param1.m01;
         this.m02 = param1.m02;
      ...
      public function setRotationMatrix(param1:Number, param2:Number, param3:Number):Matrix3_new
      {
      ...
      public function clone():Matrix3_new
      {
         return new Matrix3_new(this.m00, this.m01, this.m02, this.m10, this.m11, this.m12, this.m20, this.m21, this.m22);
      }
      ...
      public function rotationMatrixToQuaternion(param1:Quaternion):void
      {
         ...
         var _loc2_:Number = this.m00 + this.m11 + this.m22;
         if (_loc2_ > 0)
         {
            _loc3_ = Math.sqrt(_loc2_ + 1) * 2;
            param1.w = 0.25 * _loc3_;
            param1.x = (this.m21 - this.m12) / _loc3_;
            param1.y = (this.m02 - this.m20) / _loc3_;
            param1.z = (this.m10 - this.m01) / _loc3_;
         }
         else if (this.m00 > this.m11 && this.m00 > this.m22)
         {
            _loc3_ = Math.sqrt(1 + this.m00 - this.m11 - this.m22) * 2;
            param1.w = (this.m21 - this.m12) / _loc3_;
            param1.x = 0.25 * _loc3_;
            param1.y = (this.m01 + this.m10) / _loc3_;
            param1.z = (this.m02 + this.m20) / _loc3_;
         }
         else if (this.m11 > this.m22)
         {
            _loc3_ = Math.sqrt(1 + this.m11 - this.m00 - this.m22) * 2;
            param1.w = (this.m02 - this.m20) / _loc3_;
            param1.x = (this.m01 + this.m10) / _loc3_;
            param1.y = 0.25 * _loc3_;
            param1.z = (this.m12 + this.m21) / _loc3_;
         }
         else
         {
            _loc3_ = Math.sqrt(1 + this.m22 - this.m00 - this.m11) * 2;
            param1.w = (this.m10 - this.m01) / _loc3_;
            param1.x = (this.m02 + this.m20) / _loc3_;
            param1.y = (this.m12 + this.m21) / _loc3_;
            param1.z = 0.25 * _loc3_;
         }
      }
   }
}
