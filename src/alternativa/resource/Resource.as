package alternativa.resource
{
    ...
    public class Resource extends EventDispatcher implements IResource
    {
        ...
        final protected function loadingProgress(bytesLoaded:int, bytesTotal:int):void
        {
        ...
        final protected function completeLoading():void
        {
            this.timer.stop();
        ...
        final protected function reportFatalError(message:String):void
        {
            this.setIdleLoadingState();
