package alternativa.tanks.gui
{
    ...
    public class PaymentBugReportWindow extends Sprite
    {
        ...
        private function onSendClick(e:MouseEvent):void
        {
            ...
            this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_COMMON_LANGUAGE) + this.localeService.language) + "\n"));
            this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_COMMON_DATE) + this.dateInput.value) + "\n"));
            this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_COMMON_SYSTEM) + this.systemCombo.selectedItem["gameName"]) + "\n"));
            this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_COMMON_TRANSACTION) + this.paymentInput.value) + "\n"));
            switch (this.systemCombo.selectedItem["gameName"])
            {
                case this.localeService.getText(TextConst.PAYMENT_SMS_NAME_TEXT):
                    ...
                    {
                        this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_SMS_REQUEST_TEXT) + this.smsTextInput.value) + "\n"));
                    }
                    break;
                case this.localeService.getText(TextConst.PAYMENT_VISA_NAME_TEXT):
                    this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_CARD_TYPE) + ((!(!(this.visaCheckBox.checked))) ? "VISA" : "MaterCard")) + "\n"));
                    this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_CARD_CODE) + this.lastDigitsInput.value) + "\n"));
                    this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_CARD_NAME) + this.realNameInput.value) + "\n"));
                    this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_CARD_PHONE_NUMBER) + this.phoneNumberInput.value) + "\n"));
                    break;
                case this.localeService.getText(TextConst.PAYMENT_YANDEX_MONEY_NAME_TEXT):
                    if (this.walletNumberInput.value != "")
                    {
                        this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_YANDEX_MONEY_NUMBER) + this.walletNumberInput.value) + "\n"));
                    }
                    break;
            ...
            {
                this.reportString = (this.reportString + ((this.localeService.getText(TextConst.PAYMENT_COMMON_COMMENT) + this.descriptionInput.text) + "\n"));
            }
        ...
        {
            var i:int;
            while (i < this.tabContainers.length)
            {
            ...
            if (this.systemCombo.selectedItem != null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (systemName == this.localeService.getText(TextConst.PAYMENT_YANDEX_MONEY_NAME_TEXT))
                            {
        ...
        private function checkMainFields():void
        {
            ...
            if (this.systemCombo.selectedItem != null)
            {
                ...
                dataValid = this.paymentInput.value.length > 0
                    && !datePattern.exec(this.dateInput.value) == null;
