package alternativa.tanks.gui
{
    ...
    public class NewReferalWindow extends Sprite
    {
        ...
        public function NewReferalWindow(hash:String, bannerCodeString:String, url:String, messageTemplate:String)
        {
            ...
            this.window = new TankWindowWithHeader("REFERRALS");
            ...
            this.loader.load(new URLRequest("https://protankionline.github.io/play/tankiref2.swf"), context);
            ...
            var _local_6:* = (this.banner as Sprite);
            with (_local_6)
            {
            ...
            this.addReferals([ {income: 0, rank: 1, callsign: "none"}]);
        }
        public function addReferals(data:Array):void
        {
            ...
            while (i < data.length)
            {
                // sum = (sum + RefererIncomeData(data[i]).income);
                i++;
            }
