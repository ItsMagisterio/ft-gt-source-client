package alternativa.tanks.gui.upgrade
{
   ...
   public class UpgradeInfoForm extends DiscreteSprite
   {
      ...
      private var propertyNameLabel:MouseDisabledLabel;

      private var propertyValueLabel:MouseDisabledLabel;

      private var propertyDeltaLabel:MouseDisabledLabel;

      private var propertyNextValueLabel:MouseDisabledLabel;
      ...
      private var upgradeLayer:Sprite;
      ...
      public function UpgradeInfoForm(param1:UpgradableItemParams, param2:UpgradableItemPropertyValue)
      {
         ...
         this.propertyNextValueLabel = new MouseDisabledLabel();
         this.upgradeLayer = new DiscreteSprite();
         super();
