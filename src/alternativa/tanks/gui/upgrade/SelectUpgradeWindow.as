package alternativa.tanks.gui.upgrade
{
   ...
   public class SelectUpgradeWindow extends UpgradeWindowBase implements CountDownTimerOnTick
   {
      ...
      private var infos:Vector.<alternativa.tanks.gui.upgrade.UpgradeInfoForm>;

      private var timer:CountDownTimer;

      private var upgradableItemParams:UpgradableItemParams;

      private var progress:alternativa.tanks.gui.upgrade.UpgradeProgressForm;

      private var okButton:CrystalButton;

      public function SelectUpgradeWindow(param1:UpgradableItemParams)
      {
         var _loc5_:alternativa.tanks.gui.upgrade.UpgradeInfoForm = null;
         ...
         {
            _loc5_ = new alternativa.tanks.gui.upgrade.UpgradeInfoForm(param1, this.properties[_loc4_]);
         ...
         this.progress = new alternativa.tanks.gui.upgrade.UpgradeProgressForm(param1);
         this.progress.x = 12;
      ...
      {
         var _loc1_:alternativa.tanks.gui.upgrade.UpgradeInfoForm = null;
