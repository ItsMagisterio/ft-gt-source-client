package alternativa.tanks.gui
{
    ...
    public class PaymentWindow extends Sprite
    {
        ...
        private static const bitmapCrystalsPic:Class = PaymentWindow_bitmapCrystalsPic;
        private static const crystalsBd:BitmapData = new bitmapCrystalsPic().bitmapData;
        private static const bitmapError:Class = PaymentWindow_bitmapError;
        ...
        {
            var _loc4_:PaymentButton;
            var _loc5_:DefaultButton;
            var _loc6_:Sprite;
        ...
        public function resize(width:int, height:int):void
        {
            ...
            else
            {
                ...
                {
                    if (((this.currentTabIndex == this.INDEX_TERMINAL) && (!(this.localeService.language == "cn"))))
                    {
                ...
                this.exchangeGroup.x = (((this.currentTabIndex == this.INDEX_VISA) || (this.currentTabIndex == this.INDEX_PREPAID)) ? Number((this.chronopayButton.width + this.spaceModule)) : Number(this.colomn3x));
                this.exchangeGroup.resize(colomn3width);
                this.proceedButton.x = (((this.currentTabIndex == this.INDEX_VISA) || (this.currentTabIndex == this.INDEX_PREPAID)) ? Number(((this.chronopayButton.width + this.spaceModule) + 4)) : Number((this.colomn3x + 4)));
                this.proceedButton.y = ((!(this.exchangeGroup.visible)) ? Number(((this.spaceModule * 5) + 3)) : Number(((this.exchangeGroup.y + this.exchangeGroup.height) + this.spaceModule)));
        ...
        {
            var id:String = (this.smsBlock.countriesCombo.selectedItem["id"] as String);
            return (id);
        }
        public function get selectedOperator():int
        {
            var id:int = (this.smsBlock.operatorsCombo.selectedItem["id"] as int);
            return (id);
        }
