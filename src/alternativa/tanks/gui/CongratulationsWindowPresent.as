package alternativa.tanks.gui
{
    ...
    public class CongratulationsWindowPresent extends Sprite
    {
        ...
        private static const bitmapCrys:Class = CongratulationsWindowPresent_bitmapCrys;
        private static const crysBd:BitmapData = new bitmapCrys().bitmapData;
        private static const bitmapCryss:Class = CongratulationsWindowPresent_bitmapCryss;
        ...
        public function CongratulationsWindowPresent(_arg_1:int, bannerObject:ClientObject, numCrystals:int = 0)
        {
