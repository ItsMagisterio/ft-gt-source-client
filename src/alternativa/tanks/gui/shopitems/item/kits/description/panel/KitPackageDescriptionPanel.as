package alternativa.tanks.gui.shopitems.item.kits.description.panel
{
    ...
    public class KitPackageDescriptionPanel extends Sprite
    {
        ...
        public function resize(param1:int):void
        {
            ...
            this.center.x = 1;
            this.center.y = (((_loc3_ - (KitPackageDescriptionView.LEFT_TOP_MARGIN * 3)) - KitPackageDescriptionView.ITEM_HEIGHT) + this.center.height);
            ...
            this.fillBackgroundShape(this.backgroundFillBottomPart, this.topLeft.width, (this.center.y + this.center.height), this.top.width, (((KitPackageDescriptionView.LEFT_TOP_MARGIN * 3) + KitPackageDescriptionView.ITEM_HEIGHT) - (this.center.height * 3)));
        }
