package alternativa.tanks.help
{
    ...
    public class BubbleHelper extends Helper
    {
        ...
        private static var defaultTextFormat:TextFormat = new TextFormat("Tahoma", 10, 0xFFFFFF, true);
        ...
        private const arrowShift:int = 24;
        private const arrowWidth:int = 24;
        ...
        override public function draw(size:Point):void
        {
            ...
            {
                if ((this._arrowAlign & HelperAlign.MIDDLE_MASK))
                {
            ...
            {
                if ((this._arrowAlign & HelperAlign.CENTER_MASK))
                {
