package alternativa.tanks.model.shop.items.crystallitem
{
    ...
    public class CrystalPackageItem extends ShopItemBase
    {
        ...
        public static const premiumBMP:BitmapData = new PremiumIconSmall().bitmapData;
        ...
        public function CrystalPackageItem(itemId:String, additionalData:Object)
        {
            ...
            super(itemId, additionalData.unique_id, ShopItemSkins.GREEN);
        }
        ...
        private function initPackageWithPresent():void
        {
            ...
            if (this.additionalData.premium_duration != null)
            {
                ...
                this.premiumIcon = new Bitmap(premiumBMP);
                addChild(this.premiumIcon);
                this.premiumLabel.text = "+" + this.additionalData.premium_duration + " d";
        ...
        {
            return (this.additionalData.premium_duration != null);
        }
        private function render():void
        {
            ...
            if (this.hasPremium)
            {
                this.premiumIcon.smoothing = true;
                this.premiumIcon.width -= this.premiumIcon.width / 10;
                this.premiumIcon.height -= this.premiumIcon.height / 10;
                this.premiumLabel.x = this.crystalLabel.x;
                this.premiumIcon.x = this.premiumLabel.x + this.premiumLabel.width + 5;
                this.premiumIcon.y = this.presentLabel.y - 5;
                this.premiumLabel.y = this.presentIcon.y + 10;
            }
        }
