package alternativa.tanks.model.profile
{
    ...
    public class UserGiftsView extends Sprite
    {
        ...
        private static const emptyBitmap:Class = UserGiftsView_emptyBitmap;
        ...
        private var empty:Bitmap = new Bitmap(new emptyBitmap().bitmapData);
        private var panel:GreenPanel = new GreenPanel(450, 210);
        ...
        public function UserGiftsView(data:Array, parserInfo:Object)
        {
            ...
            this.window.height = ((this.items.length > 0) ? 450 : 325);
        ...
        private function showInfo(resource:Object):void
        {
            ...
            this.senderText.color = 0xFFFFFF;
            ...
            this.statusText.color = 0xFFFFFF;
            ...
            this.messageText.color = 0xFFFFFF;
