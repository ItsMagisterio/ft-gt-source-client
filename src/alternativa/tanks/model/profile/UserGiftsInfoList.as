package alternativa.tanks.model.profile
{
    ...
    public class UserGiftsInfoList extends Sprite implements IResourceLoadListener
    {
        ...
        private function onMouseDown(e:MouseEvent):void
        {
            ...
            rect.top = (rect.top - ADDITIONAL_SCROLL_AREA_HEIGHT);
        ...
        private function onEnterFrame(param1:Event):void
        {
            ...
            this.list.horizontalScrollPosition = (this.list.horizontalScrollPosition - (this.scrollSpeed * dt));
            ...
            {
                this.scrollSpeed = (this.scrollSpeed * Math.exp((-1.5 * dt)));
            }
            else
            {
                this.scrollSpeed = 0;
        ...
        private function onMouseMove(e:MouseEvent):void
        {
            ...
            this.sumDragWay = (this.sumDragWay + Math.abs(deltaX));
            if (this.sumDragWay > MAX_DELTA_FOR_SELECT)
            {
                this.list.horizontalScrollPosition = (this.list.horizontalScrollPosition - deltaX);
            }
            e.updateAfterEvent();
        }
        ...
        private function myIcon(param1:Object, param2:Boolean):DisplayObject
        {
            ...
            var _loc6_:ImageResource;
            var _loc8_:uint;
            var _loc10_:Bitmap;
            var _loc11_:Label;
            var _loc12_:GlowFilter;
            ...
            else
            {
                if (_loc6_.loaded())
                {
                    ...
                    _loc10_.width = (_loc10_.width * 0.85);
                    _loc10_.height = (_loc10_.height * 0.85);
                    _loc10_.x = 13;
                    _loc10_.y = 18;
