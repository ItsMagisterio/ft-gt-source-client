package alternativa.tanks.model
{
    ...
    public class BattleSelectModel extends BattleSelectModelBase implements IBattleSelectModelBase, IObjectLoadListener, IResourceLoadListener, IDumper
    {
        ...
        private var translate:Dictionary = new Dictionary();
        ...
        public function initObject(clientObject:ClientObject, cost:int, haveSubscribe:Boolean, maps:Array):void
        {
            var mapId:String;
            var m:MapClient;
            var previewBitmap:BitmapData;
            var mapParams:BattleMap;
        ...
        public function resourceLoaded(resource:Object):void
        {
            ...
            if (resource.id == this.viewBattleExpectedResourceId)
            {
                ...
                {
                    if (((!(this.viewTDM == null)) && (this.layer.contains(this.viewTDM))))
                    {
            ...
            {
                if (resource.id == this.createBattleExpectedResourceId)
                {
        ...
        {
            var garageAvailableAlert:Alert;
            var dialogsLayer:DisplayObjectContainer;
            var timer:Timer = new Timer(10, 1);
            timer.addEventListener(TimerEvent.TIMER_COMPLETE, function(e:TimerEvent):void
                {
                    var i:int;
                    var selectedBattleId:String;
                    ...
                    showList();
                    if (internal::battles != null)
                    {
                        i = 0;
                        while (i < internal::battles.length)
                        {
                            addBattle(internal::clientObject, BattleClient(internal::battles[i]));
                            i++;
                        }
                        selectedBattleId = checkSelectedBattle();
                        if (((selectedBattleId == null) || (onLink)))
                        {
                            selectBattle(internal::clientObject, internal::recommendedBattle);
                        }
                        else
                        {
                            selectBattle(internal::clientObject, selectedBattleId);
                        }
                    }
                    if (Lobby.firstInit)
                    {
            ...
            if (this.battleList != null)
            {
                ...
                if (team)
                {
                    ...
                    while (i < users.length)
                    {
                        ...
                        this.viewTDM.updatePlayer(((userInfo.type == BattleTeamType.RED) ? ViewTDM.RED_TEAM : ViewTDM.BLUE_TEAM), userInfo.id, userInfo.name, userInfo.rank, userInfo.kills);
                        i++;
                    }
        ...
        private function onAddressChange(e:SWFAddressEvent):void
        {
            ...
            {
                i = 0;
                while (i < this.battlesArray.length)
                {
        ...
        {
            this.battleToSelect = this.createBattleForm.gameName;
            if (this.createBattleForm.deathMatch)
            {
                this.createBattle(this.clientObject, this.createBattleForm.gameName, (this.createBattleForm.mapID as String), this.createBattleForm.time, this.createBattleForm.numKills, this.createBattleForm.numPlayers, this.createBattleForm.minRang, this.createBattleForm.maxRang, this.createBattleForm.PrivateBattle, this.createBattleForm.proBattle, ((this.createBattleForm.proBattle) ? (!(this.createBattleForm.inventoryBattle)) : false), this.createBattleForm.getMode, this.createBattleForm.microUpradesEnabled, this.createBattleForm.changeEquipment, this.createBattleForm.battleFormat);
            }
            else if (this.createBattleForm.CaptureTheFlag)
            {
                this.createBattleCaptureFlag(this.clientObject, this.createBattleForm.gameName, (this.createBattleForm.mapID as String), this.createBattleForm.time, this.createBattleForm.numFlags, this.createBattleForm.numPlayers, this.createBattleForm.minRang, this.createBattleForm.maxRang, this.createBattleForm.autoBalance, this.createBattleForm.friendlyFire, this.createBattleForm.PrivateBattle, this.createBattleForm.proBattle, ((this.createBattleForm.proBattle) ? (!(this.createBattleForm.inventoryBattle)) : false), this.createBattleForm.getMode, this.createBattleForm.microUpradesEnabled, this.createBattleForm.changeEquipment, this.createBattleForm.battleFormat);
            }
            else if (this.createBattleForm.Team)
            {
                this.createBattleTeam(this.clientObject, this.createBattleForm.gameName, (this.createBattleForm.mapID as String), this.createBattleForm.time, this.createBattleForm.numKills, this.createBattleForm.numPlayers, this.createBattleForm.minRang, this.createBattleForm.maxRang, this.createBattleForm.autoBalance, this.createBattleForm.friendlyFire, this.createBattleForm.PrivateBattle, this.createBattleForm.proBattle, ((this.createBattleForm.proBattle) ? (!(this.createBattleForm.inventoryBattle)) : false), this.createBattleForm.getMode, this.createBattleForm.microUpradesEnabled, this.createBattleForm.changeEquipment, this.createBattleForm.battleFormat);
            }
            else if (this.createBattleForm.DOM)
            {
                this.createBattleDominationOfMap(this.clientObject, this.createBattleForm.gameName, (this.createBattleForm.mapID as String), this.createBattleForm.time, this.createBattleForm.numPoints, this.createBattleForm.numPlayers, this.createBattleForm.minRang, this.createBattleForm.maxRang, this.createBattleForm.autoBalance, this.createBattleForm.friendlyFire, this.createBattleForm.PrivateBattle, this.createBattleForm.proBattle, ((this.createBattleForm.proBattle) ? (!(this.createBattleForm.inventoryBattle)) : false), this.createBattleForm.getMode, this.createBattleForm.microUpradesEnabled, this.createBattleForm.changeEquipment, this.createBattleForm.battleFormat);
            }
            this.hideCreateForm();
        }
        private function createBattleDominationOfMap(clientObject:ClientObject, gameName:String, mapId:String, time:int, numPointsScore:int, numPlayers:int, minRang:int, maxRang:int, autoBalance:Boolean, friendlyFire:Boolean, privateBattle:Boolean, payBattle:Boolean, inventory:Boolean, hrMode:int, microUpgrades:Boolean, equipmentChange:Boolean, battleFormat:int):void
        {
            ...
            json.microUpgrades = microUpgrades;
            json.equipmentChange = equipmentChange;
            json.battleFormat = battleFormat;
            Network(Main.osgi.getService(INetworker)).send(("lobby;try_create_battle_dom;" + JSON.stringify(json)));
        }
        private function createBattleCaptureFlag(clientObject:ClientObject, gameName:String, mapId:String, time:int, numFlags:int, numPlayers:int, minRang:int, maxRang:int, autoBalance:Boolean, friendlyFire:Boolean, privateBattle:Boolean, payBattle:Boolean, inventory:Boolean, hrMode:int, microUpgrades:Boolean, equipmentChange:Boolean, battleFormat:int):void
        {
            var json:Object = new Object();
            json.gameName = gameName;
            json.mapId = mapId;
        ...
        private function createBattleTeam(cl:ClientObject, gameName:String, mapId:String, time:int, numKills:int, numPlayers:int, minRang:int, maxRang:int, autoBalance:Boolean, frielndyFire:Boolean, privateBattle:Boolean, pay:Boolean, inventory:Boolean, hrMode:int, microUpgrades:Boolean, equipmentChange:Boolean, battleFormat:int):void
        {
            var json:Object = new Object();
            json.gameName = gameName;
            json.mapId = mapId;
        ...
        private function createBattle(cl:ClientObject, gameName:String, id:String, time:Number, numKills:Number, numPlayers:Number, minRang:int, maxRang:int, isPrivate:Boolean, isPay:Boolean, isX3:Boolean, hrMode:int, microUpgrades:Boolean, equipmentChange:Boolean, battleFormat:int):void
        {
            Network(Main.osgi.getService(INetworker)).send("lobby;try_create_battle_dm;" + gameName + ";" + id + ";" + time + ";" + numKills + ";" + numPlayers + ";" + minRang + ";" + maxRang + ";" + isPrivate + ";" + isPay + ";" + isX3 + ";" + microUpgrades + ";" + equipmentChange + ";" + battleFormat);
        }
        ...
        public function startLoadBattle():void
        {
            ...
            if (ChatModel(Main.osgi.getService(IChatModelBase)) != null)
            {
        ...
        {
            if (this.gameNameBeforeCheck != null)
            {
