package alternativa.tanks.model.garage.upgrade
{
   ...
   public class DelayUpgrades
   {
      ...
      private var flush:alternativa.tanks.model.garage.upgrade.FlushUpgrades;

      private var timeoutId:int;

      private var item:IGameObject;

      public function DelayUpgrades(param1:alternativa.tanks.model.garage.upgrade.FlushUpgrades)
      {
         super();
         this.flush = param1;
         this.clear();
