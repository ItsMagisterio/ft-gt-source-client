package alternativa.tanks.model.garage.upgrade
{
   ...
   public class UpgradeGarageItemModel extends UpgradeGarageItemModelBase implements IUpgradeGarageItemModelBase, UpgradeGarageItem, ObjectLoadPostListener, CountDownTimerOnCompleteBefore, ObjectUnloadListener, ObjectLoadListener, FlushUpgrades
   {
      ...
      private var delayUpgrades:alternativa.tanks.model.garage.upgrade.DelayUpgrades;
      ...
      public function objectLoaded():void
      {
         ...
         this.delayUpgrades = new alternativa.tanks.model.garage.upgrade.DelayUpgrades(FlushUpgrades(object.adapt(FlushUpgrades)));
      ...
      public function flushToServer(param1:alternativa.tanks.model.garage.upgrade.DelayUpgrades, param2:IGameObject):void
      {
         var _loc3_:int = 0;
         if (param1.isDelayed())
         {
