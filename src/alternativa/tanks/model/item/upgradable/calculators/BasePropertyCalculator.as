...
{
   public class BasePropertyCalculator implements PropertyCalculator, alternativa.tanks.model.item.upgradable.calculators.PropertyValueCalculator
   {
      ...
      private var calculator:alternativa.tanks.model.item.upgradable.calculators.PropertyValueCalculator;

      public function BasePropertyCalculator(param1:int, param2:alternativa.tanks.model.item.upgradable.calculators.PropertyValueCalculator)
      {
         super();
