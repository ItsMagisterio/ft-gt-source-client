package alternativa.tanks.service.upgradingitems
{
   ...
   public class UpgradingItemsServiceImpl implements UpgradingItemsService, CountDownTimerOnCompleteAfter, OnConnectionClosedServiceListener
   {
      ...
      private var upgradingItems:Vector.<alternativa.tanks.service.upgradingitems.ItemInfo>;
      ...
      {
         this.upgradingItems = new Vector.<ItemInfo>();
         super();
      }
      ...
      {
         var _loc3_:alternativa.tanks.service.upgradingitems.ItemInfo = new alternativa.tanks.service.upgradingitems.ItemInfo(param1, param2);
      ...
      {
         var _loc2_:alternativa.tanks.service.upgradingitems.ItemInfo = null;
         if (this.alert != null)
         {
            return;
         }
         var _loc1_:Vector.<alternativa.tanks.service.upgradingitems.ItemInfo> = new Vector.<ItemInfo>();
      ...
      private function showUpgradedItems(param1:Vector.<alternativa.tanks.service.upgradingitems.ItemInfo>):void
      {
      ...
      private function show(param1:Vector.<alternativa.tanks.service.upgradingitems.ItemInfo>, param2:String, param3:String):void
      {
         if (param1.length > 0)
         {
      ...
      {
         var _loc1_:alternativa.tanks.service.upgradingitems.ItemInfo = null;
      ...
      private function compare(param1:alternativa.tanks.service.upgradingitems.ItemInfo, param2:alternativa.tanks.service.upgradingitems.ItemInfo):Number
      {
      ...
      {
         var _loc4_:alternativa.tanks.service.upgradingitems.ItemInfo = null;
      ...
      {
         var _loc3_:alternativa.tanks.service.upgradingitems.ItemInfo = null;
         var _loc2_:int = 0;
