package alternativa.tanks.service.settings.keybinding
{
   ...
   public class KeyCodesConverter
   {
      ...
      {
         var _loc2_:String = String(keyCodeToLabel[param1]);
      ...
      private function initLabelDictionary():void
      {
         ...
         keyCodeToLabel[Keyboard.LEFT] = "Left";
         keyCodeToLabel[Keyboard.UP] = "Up";
         keyCodeToLabel[Keyboard.RIGHT] = "Right";
         keyCodeToLabel[Keyboard.DOWN] = "Down";
         ...
         keyCodeToLabel[Keyboard.PAGE_DOWN] = "PG_DOWN";
         keyCodeToLabel[Keyboard.PAGE_UP] = "PG_UP";
         keyCodeToLabel[Keyboard.SPACE] = "Space";
