package alternativa.tanks.service.itempropertyparams
{
   ...
   public class ItemPropertyParamsServiceImpl implements ItemPropertyParamsService
   {
      ...
      public function initPropertyParamsMap():void
      {
         ...
         this.registerGarageProperty(ItemGarageProperty.DRONE_INVENTORY_COOLDOWN_SUBTRACTION, 223, ItemInfoPanelBitmaps.cooldownBoostIcon, TanksLocale.DRONE_INVENTORY_COOLDOWN_SUBTRACTION, ItemProperty.DRONE_INVENTORY_COOLDOWN_SUBTRACTION, 0.001);
         this.registerGarageProperty(ItemGarageProperty.DRONE_SUPPORT_SCORE_FACTOR, 224, ItemInfoPanelBitmaps.durationEffectInventoryIcon, null, null);
         this.registerGarageProperty(ItemGarageProperty.DRONE_ARMOR_PERCENT, 226, ItemInfoPanelBitmaps.armorBoostIcon, TanksLocale.DRONE_ARMOR_PERCENT, ItemProperty.DRONE_ARMOR_PERCENT);
         this.registerGarageProperty(ItemGarageProperty.DRONE_DAMAGE_PERCENT, 227, ItemInfoPanelBitmaps.powerBoostIcon, TanksLocale.DRONE_DAMAGE_PERCENT, ItemProperty.DRONE_DAMAGE_PERCENT);
         this.registerGarageProperty(ItemGarageProperty.DRONE_HULL_SPEED_PERCENT, 228, ItemInfoPanelBitmaps.speed, TanksLocale.DRONE_HULL_SPEED_PERCENT, ItemProperty.DRONE_HULL_SPEED_PERCENT);
         this.registerGarageProperty(ItemGarageProperty.DRONE_HULL_ACCELERATION_PERCENT, 229, ItemInfoPanelBitmaps.speed, null, null);
         this.registerGarageProperty(ItemGarageProperty.DRONE_TURRET_ROTATION_SPEED_PERCENT, 230, ItemInfoPanelBitmaps.speed, null, null);
         this.registerGarageProperty(ItemGarageProperty.DRONE_DEPENDENT_INVENTORY_COOLDOWN, 231, ItemInfoPanelBitmaps.durationEffectInventoryIcon, TanksLocale.DRONE_DEPENDENT_INVENTORY_COOLDOWN, ItemProperty.DRONE_DEPENDENT_INVENTORY_COOLDOWN, 0.001);
      }
