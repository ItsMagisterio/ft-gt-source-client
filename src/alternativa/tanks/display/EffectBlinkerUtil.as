package alternativa.tanks.display
{
   ...
   public class EffectBlinkerUtil
   {
      ...
      {
         var _loc7_:int = 0;
         var _loc2_:int = EffectBlinkerUtil.INITIAL_BLINK_INTERVAL;
         var _loc3_:int = EffectBlinkerUtil.MIN_INTERVAL;
         var _loc4_:Number = EffectBlinkerUtil.MIN_VALUE;
         var _loc5_:Number = EffectBlinkerUtil.MAX_VALUE;
         var _loc6_:Number = EffectBlinkerUtil.SPEED_COEFF;
         if (param1 == InventoryItemType.FIRST_AID)
         {
            _loc7_ = EffectBlinkerUtil.FIRST_AID_BLINK_INTERVAL_DECREMENT;
         }
         else
         {
            _loc7_ = EffectBlinkerUtil.BLINK_INTERVAL_DECREMENT;
         }
