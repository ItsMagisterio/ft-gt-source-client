package alternativa.tanks.models.battlefield
{
    ...
    public class BattleView3D extends Sprite
    {
        ...
        public function BattleView3D(showAxisIndicator:Boolean, collisionDetector:ICollisionDetector, bs:BattlefieldModel)
        {
            ...
            this.camera.z = (this.camera.z + 10000);
        ...
        public function addDecal(param1:Vector3, param2:Vector3, param3:Number, param4:TextureMaterial, param5:RotationState = null, param6:Boolean = false):Decal
        {
            ...
            _loc6_.alpha = 0;
            var tween:GTween = new GTween(_loc6_, 0.55, {alpha: 1}, {ease: Sine.easeInOut});
            return (_loc6_);
        }
        ...
        {
            var tween:GTween = new GTween(param1, 2, {alpha: 0}, {ease: Sine.easeInOut});
            tween.onComplete = function():void
            {
                disposeDecal(param1);
            }
        }
        public function disposeDecal(param1:Decal):void
        {
            if (param1 != null)
            {
