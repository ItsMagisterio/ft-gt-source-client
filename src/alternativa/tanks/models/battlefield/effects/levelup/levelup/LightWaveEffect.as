    ...
    public class LightWaveEffect extends PooledObject implements IGraphicEffect
    {
        ...
        public function play(param1:int, param2:GameCamera):Boolean
        {
            ...
            if (this.time >= this.delay)
            {
                if (this.direction)
                {
                    this.wave.rotation = (this.wave.rotation + ((0.2 * param1) * 0.001));
                }
                else
                {
                    this.wave.rotation = (this.wave.rotation - ((0.2 * param1) * 0.001));
                ...
                if (this.state == 0)
                {
                    ...
                    this.wave.scaleX = (this.wave.scaleX + _loc7_);
                    this.wave.scaleY = (this.wave.scaleY + _loc7_);
                    this.wave.scaleZ = (this.wave.scaleZ + _loc7_);
                ...
                else
                {
                    if (this.state == 1)
                    {
                        ...
                        this.wave.scaleX = (this.wave.scaleX - _loc8_);
                        this.wave.scaleY = (this.wave.scaleY - _loc8_);
                        this.wave.scaleZ = (this.wave.scaleZ - _loc8_);
