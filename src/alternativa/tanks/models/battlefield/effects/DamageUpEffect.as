package alternativa.tanks.models.battlefield.effects
{
    ...
    public class DamageUpEffect extends PooledObject implements IGraphicEffect
    {
        ...
        public function init(param1:int, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Object3D, param12:TextureMaterial, param13:String, type:int):void
        {
            this.delay = param1;
            this.damage.width = param2 - 2;
            this.damage.height = param3 - 2;
            ...
            this.x = param8;
            this.y = (param9 - 250) + Math.random() * 500;
            this.z = (param10 - 200) + Math.random() * 100;
            this.object = param11;
            this.damage.material = param12;
            if (type == 1)
            {
                this.damage.colorTransform = new ColorTransform(0.75, 0, 0, 1, 1);
            }
            ...
            this.damage.sorting = Sorting.AVERAGE_Z;
        ...
        public function play(param1:int, param2:GameCamera):Boolean
        {
            ...
            this.z = (this.z + (((this.maxHeight * this.heightSpeed) * param1) * 0.00075));
