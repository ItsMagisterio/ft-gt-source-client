package alternativa.tanks.models.battlefield.inventory
{
   ...
   import alternativa.tanks.models.battlefield.inventory.hud.HudInventoryIcon;
   ...
   public class InventoryPanelSlot
   {
      ...
      public function update(param1:int):void
      {
         ...
         if (this.inited)
         {
            this.inventoryItem.getCooldownStatus(param1);
         }

      }
      public function canActivate():Boolean
      {
         return _cooldownItem.canActivate();
      }
