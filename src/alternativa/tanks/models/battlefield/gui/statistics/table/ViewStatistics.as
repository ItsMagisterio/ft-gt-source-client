package alternativa.tanks.models.battlefield.gui.statistics.table
{
    ...
    public class ViewStatistics extends Sprite
    {
        ...
        public function ViewStatistics(_arg_1:int, localUserId:String, finish:Boolean)
        {
        ...
        public function updatePlayer(id:Object, name:String, rank:int, kills:int, deaths:int, score:int, reward:int, isPremium:Boolean):void
        {
        ...
        private function init():void
        {
            ...
            this.inner.width = (((((((((TableConst.LAST_COLUMN_EXTRA_WIDTH + (2 * TableConst.TABLE_MARGIN)) + TableConst.LABELS_OFFSET) + TableConst.CALLSIGN_WIDTH) + TableConst.KILLS_WIDTH) + TableConst.DEATHS_WIDTH) + TableConst.RATIO_WIDTH) + ((!(this.type == GREEN)) ? TableConst.SCORE_WIDTH : 0)) + ((!(!(this.finish))) ? TableConst.REWARD_WIDTH : 0)) + EXTRA_WIDTH);
