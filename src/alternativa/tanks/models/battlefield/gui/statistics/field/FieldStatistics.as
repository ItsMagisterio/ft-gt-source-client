package alternativa.tanks.models.battlefield.gui.statistics.field
{
    ...
    public class FieldStatistics extends Sprite
    {
        ...
        private var domScoreField:DOMScoreIndicator;
        ...
        private function initFields(initData:BattleStatInfo):void
        {
            ...
            if (((initData.scoreLimit > 0) || (initData.timeLimit > 0)))
            {
                ...
                iconType = ((this.battleType == BattleType.DOM) ? 10 : ((this.battleType == BattleType.CTF) ? BattleInfoIcons.CTF : BattleInfoIcons.KILL_LIMIT));
            ...
            switch (this.battleType)
            {
                ...
                case BattleType.CTF:
                    ...
                    break;
                case BattleType.DOM:
                    this.domScoreField = new DOMScoreIndicator();
                    this.setTeamScore(BattleTeamType.BLUE, initData.blueScore);
                    this.setTeamScore(BattleTeamType.RED, initData.redScore);
                    addChild(this.domScoreField);
                    break;
            }
            this.onResize(null);
        }
        ...
        public function setTeamScore(teamType:BattleTeamType, score:int):void
        {
            ...
            {
                if (this.domScoreField != null)
                {
                    this.domScoreField.setTeamScore(teamType, score);
                }
                else
                {
        ...
        public function resetFields():void
        {
            ...
            if (this.domScoreField != null)
            {
                this.domScoreField.setScore(0, 0);
            }
            if (this.ctfScoreField != null)
            {
        ...
        private function onResize(e:Event):void
        {
            ...
            if (this.domScoreField != null)
            {
                this.domScoreField.y = ((Main.stage.stageHeight - this.domScoreField.height) - 10);
                this.domScoreField.x = ((Main.stage.stageWidth - this.domScoreField.width) - 10);
                refX = this.domScoreField.x;
            }
            if (this.ctfScoreField != null)
            {
        ...
        {
            return (this.fieldsFrame.x);
        }
        public function getPositionY():int
        {
            return (this.fieldsFrame.y);
        }
        private function getScoreWinkLimit():int
        {
            return ((this.battleType == BattleType.CTF) ? this.CTF_SCORE_WINK_LIMIT : this.SCORE_WINK_LIMIT);
        }
