package alternativa.tanks.models.battlefield.gui.chat
{
    ...
    public class BattleChat extends Sprite
    {
        ...
        public function addUserMessage(messageLabel:String, userName:String, userRank:int, chatLevel:int, teamType:BattleTeamType, text:String, premium:Boolean):void
        {
            if (LobbyChat.blocked(userName))
            {
                return;
            }
            this.output.addLine(messageLabel, userRank, chatLevel, userName, teamType, text, premium);
            this.onResize();
        }
        ...
        private function init():void
        {
            ...
            this.spectators.textColor = 0xFFFF00;
