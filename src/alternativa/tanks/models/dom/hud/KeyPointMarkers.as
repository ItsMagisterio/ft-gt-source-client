package alternativa.tanks.models.dom.hud
{
    ...
    public class KeyPointMarkers
    {
        ...
        private static const CON_HIDE_SCALE:ConsoleVarFloat = new ConsoleVarFloat("ph_scale", 0.12, 1E-5, 10);
        private static const CON_FULL_HIDE_SCALE:ConsoleVarFloat = new ConsoleVarFloat("pfh_scale", 0.1, 1E-5, 10);
        ...
        private function projectToView(param1:Vector3):void
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    param1.x = (param1.x * (_loc2_ / _loc3_));
                    param1.y = (param1.y * (_loc2_ / _loc3_));
                }
            }
        }
