package alternativa.tanks.models.sfx
{
    public class LightingEffectRecord
    {
        ...
        public function toString():String
        {
            ...
            _loc1_ = (_loc1_ + (("attenuationBegin = " + this.attenuationBegin) + " "));
            _loc1_ = (_loc1_ + (("attenuationEnd = " + this.attenuationEnd) + " "));
            _loc1_ = (_loc1_ + (("color = " + this.color) + " "));
            _loc1_ = (_loc1_ + (("intensity = " + this.intensity) + " "));
            _loc1_ = (_loc1_ + (("time = " + this.time) + " "));
            return (_loc1_ + "]");
        }
