package alternativa.tanks.models.weapon.molot
{
    ...
    public class MolotModel extends GunModelBase implements IGunModelBase, IObjectLoadListener, IWeaponController
    {

        public static var DISTANCE_WEIGHT:Number = 0.5;
        private static const DECAL:Class = MolotModel_DECAL;
        ...
        private var nextReadyTime:SecureInt = new SecureInt("molot_next_ready_time");
        ...
        private var currTime:SecureInt = new SecureInt("molot_curr_time");

        public function MolotModel()
        {
