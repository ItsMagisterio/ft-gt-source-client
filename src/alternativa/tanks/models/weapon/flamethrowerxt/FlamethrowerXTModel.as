package alternativa.tanks.models.weapon.flamethrowerxt
{
    ...
    public class FlamethrowerXTModel extends FlameThrowerModelBase implements IFlameThrowerModelBase, IFlamethrowerXT, IWeaponController
    {
        ...
        private var targetValidator:ITargetValidator = new FlamethrowerXTTargetValidator();

        public function FlamethrowerXTModel()
        {
            _interfaces.push(IModel, IFlameThrowerModelBase, IFlamethrowerXT, IWeaponController);
        }
        public function initObject(clientObject:ClientObject, coneAngle:Number, coolingSpeed:int, heatingLimit:int, heatingSpeed:int, range:Number, targetDetectionIntervalMsec:int):void
        {
            ...
            clientObject.putParams(FlamethrowerXTModel, data);
        }
        ...
        {
            return (clientObject.getParams(FlamethrowerXTModel) as FlamethrowerData);
        }
