package alternativa.tanks.models.weapon.freeze
{
    ...
    public class FreezeGraphicEffect extends PooledObject implements IGraphicEffect
    {
        ...
        private var particles:Vector.<Particle> = new Vector.<Particle>(MAX_PARTICLES);
        ...
        private function addParticle():void
        {
            ...
            particle.z = ((globalMuzzlePosition.z + 50) + (offset * direction.z));
            var _local_5:* = this.numParticles++;
            this.particles[_local_5] = particle;
