...
// alternativa.tanks.models.weapon.shaft.sfx.ShaftSFXModel
...
package alternativa.tanks.models.weapon.shaft.sfx
{
    ...
    public class ShaftSFXModel implements ShaftSFX
    {
        ...
        public function initObject(clientObject:ClientObject, manualModeEffect:String, targetingSound:String, explosionId:String, trailTexture:String, muzzleFlashTexture:String, owner:ClientObject):void
        {
            session = owner.sessionId;
            var sfxData:ShaftSFXData;
            var trailBitmapData:BitmapData;
            var trailMaterial:TextureMaterial;
            var exlpBitmap:BitmapData;
            var muzzleFlash:BitmapData;
