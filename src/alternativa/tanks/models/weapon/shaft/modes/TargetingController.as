...
// alternativa.tanks.models.weapon.shaft.modes.TargetingController
...
package alternativa.tanks.models.weapon.shaft.modes
{
    ...
    public class TargetingController
    {
        ...
        public var shaftMode:ShaftModes = ShaftModes.TARGET_ACTIVATION;
        ...
        public function enter(time:int):void
        {
            ...
            this.sfxModel = WeaponsManager.getShaftSFX(WeaponsManager.getObjectFor(TankData.localTankData.turret.id), this.tankModel.localUserData.tank.tankData.user);
        }
        ...
        public function update(param1:int, param2:int):void
        {
            ...
            switch (this.shaftMode)
            {
                ...
                case ShaftModes.TARGETING:
                    ...
                    this.up = Boolean((TankData.localTankData.ctrlBits & TankModel.FORWARD));
                    this.down = Boolean((TankData.localTankData.ctrlBits & TankModel.BACK));
