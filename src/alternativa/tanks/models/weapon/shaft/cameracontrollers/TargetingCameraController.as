...
// alternativa.tanks.models.weapon.shaft.cameracontrollers.TargetingCameraController
...
package alternativa.tanks.models.weapon.shaft.cameracontrollers
{
    ...
    public class TargetingCameraController implements ICameraController
    {
        ...
        public var maxAngle:Number = 3.14159265358979;
        ...
        public function update(gam:GameCamera, param1:int, param2:int):void
        {
            var cam:GameCamera;
            ...
            cam = this.battlefieldModel.bfData.viewport.camera;
        ...
        private function stableRandom(k:Number):Number
        {
            var rd1:Number = Math.random();
            var rd2:Number = Math.random();
            this.sign = ((rd2 > Math.pow(0.5, k)) ? -(this.sign) : this.sign);
            return (this.sign * rd1);
        }

        private function stableRandomSign(k:Number):Number
        {
            this.sign = ((Math.random() > Math.pow(0.5, k)) ? -(this.sign) : this.sign);
            return (this.sign);
        }
