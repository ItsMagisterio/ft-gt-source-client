...
// alternativa.tanks.models.weapon.shaft.quickshot.ShaftTargetSystem
...
package alternativa.tanks.models.weapon.shaft.quickshot
{
    ...
    public class ShaftTargetSystem
    {
        ...
        public function getAimTargets(shooterData:TankData, barrelOrigin:Vector3, baseDir:Vector3, rotationAxis:Vector3, tanks:Dictionary, shotResult:ShaftShotResult):void
        {
            shotResult.targets.length = 0;
            shotResult.hitPoints.length = 0;
            this.bestEffectivity = 0;
            ...
            if (this.bestEffectivity == 0)
            {
                this.collectTargetsAndTurretsAlongRay(shooterData, barrelOrigin, baseDir, tanks, shotResult);
            }
            this.multybodyPredicate.bodies = null;
            this.currHitPoints.length = 0;
            this.currTargets.length = 0;
        ...
        // private function checkDirectionForShaft(barrelOrigin:Vector3, barrelDir:Vector3, angle:Number, dirIndex:int, shooterData:TankData, tanks:Dictionary, shotResult:ShaftShotResult):void{
        // var distance:Number;
        // var directionPriority:Number;
        // var len:int;
        // var i:int;
        ...
        private function collectTargetsAndTurretsAlongRay(shooterData:TankData, barrelOrigin:Vector3, barrelDir:Vector3, tanks:Dictionary, shotResult:ShaftShotResult):void
        {
            var body:Body;
            var targetData:TankData;
            shotResult.hitPoints.length = 0;
            ...
            this.multybodyPredicate.bodies[shooterData.tank] = true;
            this.origin.vCopy(barrelOrigin);
            while (this.collisionDetector.intersectRay(this.origin, barrelDir, CollisionGroup.WEAPON, this.MAX_RAY_LENGTH, this.multybodyPredicate, this.intersection))
            {
                body = this.intersection.primitive.body;
                if (body == null)
                {
