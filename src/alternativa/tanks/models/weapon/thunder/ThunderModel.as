package alternativa.tanks.models.weapon.thunder
{
    ...
    public class ThunderModel extends ThunderModelBase implements IThunderModelBase, IWeaponController, IObjectLoadListener
    {
        ...
        public function initObject(clientObject:ClientObject, impactForce:Number, maxSplashDamageRadius:Number, minSplashDamagePercent:Number, minSplashDamageRadius:Number, ownerTank:ClientObject):void
        {
            ...
            WeaponsManager.getThunderSFX(WeaponsManager.getObjectFor(clientObject.id), ownerTank);
            this.objectLoaded(clientObject);
            this.initSFXModel(clientObject, ownerTank);
        }
        ...
        {
            this.sfxModel = WeaponsManager.getThunderSFX(WeaponsManager.getObjectFor(object.id), owner);
        }
