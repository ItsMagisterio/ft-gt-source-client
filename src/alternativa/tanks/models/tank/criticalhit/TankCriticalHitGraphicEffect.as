package alternativa.tanks.models.tank.criticalhit
{
   ...
   public class TankCriticalHitGraphicEffect implements IGraphicEffect
   {
      ...
      public function TankCriticalHitGraphicEffect(tankData:TankData)
      {
         super();
      ...
      private function createEffects():void
      {
         ...
         var explosionModel:TankCriticalHitModel = Main.osgi.getService(ITankCriticalHitModel) as TankCriticalHitModel;
