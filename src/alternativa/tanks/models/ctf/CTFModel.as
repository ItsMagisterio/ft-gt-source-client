package alternativa.tanks.models.ctf
{
    ...
    public class CTFModel extends CaptureTheFlagModelBase implements ICaptureTheFlagModelBase, ICTFModel, IObjectLoadListener, IBattlefieldPlugin, IDumper
    {
        ...
        public static const COLOR_POSITIVE:uint = 0xFF00;
        public static const COLOR_NEGATIVE:uint = 0xFFFF00;
        ...
        private var flagLockTime:SecureInt = new SecureInt("flagLockTime");
        ...
        {
            var flag:CTFFlag;
            var userTeamFlag:CTFFlag;
            var otherTeamFlag:CTFFlag;
            if (this.flags == null)
            {
                return;
            }
            if (((!(this.userTankData == null)) && (this.userTankData.enabled)))
            {
                ...
                {
                    if (((otherTeamFlag.carrierData == this.userTankData) && (userTeamFlag.state == CTFFlagState.AT_BASE)))
                    {
        ...
        private function initFlag(teamType:BattleTeamType, flagSpec:ClientFlag, flagData:FlagData):void
        {
            ...
            {
                texture = new BitmapData(this.FLAG_FRAME_WIDTH, this.FLAG_FRAME_HEIGHT, false, ((teamType == BattleTeamType.RED) ? uint(0xAA0000) : uint(170)));
            }
            ...
            pos.z = (pos.z - (CTFFlag.Z_DISPLACEMENT - 1));
            pedestal.x = pos.x;
            pedestal.y = pos.y;
            pedestal.z = pos.z;
        ...
        private function doDropFlag():void
        {
            ...
            this.pos3d.y = pos.y;
            this.pos3d.z = pos.z;
            if (this.bfData.collisionDetector.intersectRayWithStatic(pos, rayDirection, CollisionGroup.STATIC, 1, null, intersection))
            {
...
class InitParams
{
    ...
    public function InitParams(redFlagData:FlagData, blueFlagData:FlagData)
    {
...
class FlagData
{
    ...
    public function FlagData(imageResourceId:String, pedestalModelId:String, pedestalModel_img:String)
    {
...
class FlagMessage
{
    ...
    public function FlagMessage(text:String, color:uint)
    {
        this.text = text;
        this.color = color;
    }
...
class FlagActionMessages
{
    ...
    public function FlagActionMessages(positive:FlagMessage, negative:FlagMessage)
    {
