package alternativa.tanks.materials
{
   ...
   public class AnimatedPaintMaterial extends PaintMaterial
   {
      ...
      public function AnimatedPaintMaterial(param1:BitmapData, param2:BitmapData, param3:BitmapData, numFramesX:int, numFramesY:int, fps:int, numFrames:int, param8:int = 0)
      {
