package alternativa.console
{
    ...
    public class Console implements IConsole
    {
        ...
        private var toggleKeys:Vector.<ToggleKey> = new Vector.<ToggleKey>();
...
class ToggleKey
{
    ...
    public function ToggleKey(keyCode:uint, altKey:Boolean, ctrlKey:Boolean, shiftKey:Boolean)
    {
