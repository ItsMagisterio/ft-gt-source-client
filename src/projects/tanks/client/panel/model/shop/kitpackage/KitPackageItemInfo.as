...
// projects.tanks.client.panel.model.shop.kitpackage.KitPackageItemInfo
...
package projects.tanks.client.panel.model.shop.kitpackage
{
    public class KitPackageItemInfo
    {
        ...
        public function toString():String
        {
            ...
            _loc1_ = (_loc1_ + (("count = " + this.count) + " "));
            _loc1_ = (_loc1_ + (("crystalPrice = " + this.crystalPrice) + " "));
            _loc1_ = (_loc1_ + (("itemName = " + this.itemName) + " "));
            return (_loc1_ + "]");
        }
