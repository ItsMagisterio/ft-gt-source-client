package projects.tanks.client.panel.model.garage.upgradingitems
{
   ...
   public class UpgradingItemsModelServer
   {
      ...
      private var _itemUpgradedId:Long;
      ...
      {
         this._itemUpgradedId = Long.getLong(315970156, 1555456153);
         this._selectId = Long.getLong(1964417151, -1180852710);
         super();
         this.model = param1;
      ...
      public function itemUpgraded(param1:IGameObject):void
      {
         ...
         var _loc2_:SpaceCommand = new SpaceCommand(Model.object.id, this._itemUpgradedId, this.protocolBuffer);
