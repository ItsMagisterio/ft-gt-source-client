package projects.tanks.clients.flash.commons.models.captcha
{
   ...
   public class IServerCaptchaAdapt implements projects.tanks.clients.flash.commons.models.captcha.IServerCaptcha
   {

      private var object:IGameObject;

      private var impl:projects.tanks.clients.flash.commons.models.captcha.IServerCaptcha;

      public function IServerCaptchaAdapt(param1:IGameObject, param2:projects.tanks.clients.flash.commons.models.captcha.IServerCaptcha)
      {
         super();
         this.object = param1;
         this.impl = param2;
